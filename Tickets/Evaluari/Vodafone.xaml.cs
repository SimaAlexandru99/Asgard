...
namespace Asgard.Tickets.Evaluari
{
    ...
    public partial class Vodafone : Page
    {
        ...
        {
            if (emailAngajat.Text != string.Empty && emailSuperior.Text != string.Empty && numarClient.Text != string.Empty && ComboProiect.Text != string.Empty && dataApel.Text != string.Empty && tipApel.Text != string.Empty)
            {
